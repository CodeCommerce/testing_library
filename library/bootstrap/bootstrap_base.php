...
class Bootstrap
{
    ...
    public function init()
    {
        ...
        if ($testConfig->shouldInstallShop() && $testConfig->isCurrentTestSuiteForShopTests()) {
            $this->installShop();
        }
    }
    ...
    protected function installShop()
    {
        ...
        try {
            ...
            register_shutdown_function(function($fileCopier, $shopDirectory) {
